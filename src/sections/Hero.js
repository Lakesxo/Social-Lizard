            ...
            <div className="heroView" id="hero">
                ...
                <div className="flexHero">
                    ...
                    <div className="rightHero">
                        ...
                        <img className="path" data-aos="fade-left" draggable="false" src={isMobile ? "https://res.cloudinary.com/dt9pwfpi5/image/upload/v1641982519/Group_mb_bi0s7l.png" : "https://res.cloudinary.com/dt9pwfpi5/image/upload/v1643560025/newbg_a3ghjb.png"} alt="social lizard" />
                    </div>
                </div>
